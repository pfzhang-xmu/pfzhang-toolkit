...
description: |
  Edit or review academic medical manuscripts to reduce formulaic AI-writing
  patterns while preserving scientific meaning, data, citations, and
  journal-appropriate tone. Use when the user asks to humanize, polish, or audit
  medical or scientific prose; calibrate sentence rhythm and authorial voice;
  remove inflated, vague, promotional, repetitive, or overly uniform language;
  or check paragraph cohesion and terminology consistency. Follow the skill's
  two-pass rewrite and self-audit process.
license: CC-BY-4.0
metadata:
  version: "2.0.0"
---
